/*
    ...
    <SEQUENCE 생성>
        ...
        * 캐시메모리
            ...
            - 매번 호출할 때마다 시퀀스 값을 새로 생성을 하는 것이 아닌 캐시 메모리 공간에 미리 생서오딘 값들을 사용한다.
*/
...
/*
    <SEQUENCE 수정>
         [표현법]
            ...
            - START WITH는 변경이 불가능하다. 즉, 재설정하고 싶다면 기존 시쿠너스를 삭제 후 재생성해야 한다.
*/
