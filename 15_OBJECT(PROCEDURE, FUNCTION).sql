/*
    <PROCEDURE>
        PL/SQL 문을 저장하는 객체
        필요할 때마다 복잡한 구문을 다시 입려갛 맆룡 없이 간단하게 호출해서 실행 결과를 얻을 수 있다.
...
/*
        2) 명시적 커서
            ...
            [사용방법]
                ...
                2) OPEN 커서명;                : 커서 오픈
                3) FETCH 커서명 INTO 변수, .... : 커서에서 데이터 추출()
                4) CLOSE 커서명                : 커서 닫기
